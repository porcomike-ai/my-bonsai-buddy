...
import { B as Button, d as cn, s as soinEmoji, b as soinLabel, L as Label, I as Input, T as Textarea, u as uid, l as listBonsais } from "./router-t0ineTAC.mjs";
import { s as saveJournal } from "./journal-Vg7D2S9t.mjs";
import { s as saveRappel, l as listRappels } from "./rappel-CwFhbXlh.mjs";
import { u as updateEvenement, s as saveEvenement, d as deleteEvenement, l as listEvenements } from "./evenement-C6cQFOTi.mjs";
...
import { s as startOfWeek, d as startOfMonth, e as endOfWeek, g as endOfMonth, h as eachDayOfInterval, f as format, p as parseISO, j as subMonths, k as addMonths, l as isSameMonth, m as isSameDay, a as fr, b as addDays } from "../_libs/date-fns.mjs";
import { n as ChevronLeft, o as ChevronRight, b as Check, p as CalendarPlus, P as Plus, B as Bell, X } from "../_libs/lucide-react.mjs";
...
function EvenementsSection({
  ...
  const add = async () => {
    ...
    try {
      ...
      toast.error("Échec de l'enregistrement de l'évènement : " + (e instanceof Error ? e.message : "erreur inconnue"));
      return;
    }
    qc.invalidateQueries({
      queryKey: ["evenements"]
  ...
  const update = async () => {
    ...
    try {
      ...
      toast.error("Échec de la mise à jour de l'évènement : " + (e instanceof Error ? e.message : "erreur inconnue"));
      return;
    }
    qc.invalidateQueries({
      queryKey: ["evenements"]
