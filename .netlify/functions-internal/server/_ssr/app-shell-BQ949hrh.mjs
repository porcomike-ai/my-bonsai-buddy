...
import { w as cn } from "./router-lnbQiR3D.mjs";
import { p as Leaf, K as LayoutDashboard, g as Sprout, h as Container, e as Calendar, o as BookOpen, f as ChartBar, M as Settings } from "../_libs/lucide-react.mjs";
const NAV = [
