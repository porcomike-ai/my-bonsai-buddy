...
import { Y as useBlobUrl, F as Dialog, H as DialogContent, K as DialogTitle, B as Button } from "./router-t0ineTAC.mjs";
...
function PhotoLightbox({ photo, open, onOpenChange }) {
  ...
  reactExports.useEffect(() => {
    ...
    let cancelled = false;
    import("./photo-cache-LDr-U0DB.mjs").then(({ getCachedPhotoBlob }) => getCachedPhotoBlob(photo)).then((b) => {
