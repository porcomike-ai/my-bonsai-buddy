...
import { B as Button, w as cn, L as Label, I as Input, T as Textarea, p as saveJournal, u as uid, q as saveRappel, r as saveEvenement, y as deleteEvenement, b as listRappels, l as listBonsais, x as listEvenements } from "./router-B380VHsD.mjs";
import { A as AppShell, n as notificationStatus, r as requestNotificationPermission } from "./app-shell-DVADMHR6.mjs";
...
import { r as ChevronLeft, s as ChevronRight, b as Check, t as CalendarPlus, P as Plus, u as Bell, X, v as BellOff, w as BellRing } from "../_libs/lucide-react.mjs";
...
function EvenementsSection({
  ...
  const [notifStatus, setNotifStatus] = reactExports.useState(() => notificationStatus());
  const ask = async () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mt-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex flex-wrap items-center justify-between gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(NotifBadge, { status: notifStatus, onAsk: ask }),
...
function NotifBadge({
  ...
  if (status === "unsupported") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-secondary px-3 py-1 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(BellOff, { className: "h-3 w-3" }),
      " Notifications non supportées"
    ] });
  }
  if (status === "granted") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 rounded-full bg-sage/30 px-3 py-1 text-xs text-forest", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(BellRing, { className: "h-3 w-3" }),
      " Notifications activées"
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: onAsk, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "mr-1 h-3.5 w-3.5" }),
