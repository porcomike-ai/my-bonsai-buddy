...
import { getCachedPhotoBlob } from "./photo-cache-LDr-U0DB.mjs";
import { Y as useBlobUrl, d as cn } from "./router-t0ineTAC.mjs";
...
function BonsaiPhoto({
  ...
  reactExports.useEffect(() => {
    ...
    getCachedPhotoBlob({ storagePath: photoId, poterieId: void 0 }).then((blob2) => {
