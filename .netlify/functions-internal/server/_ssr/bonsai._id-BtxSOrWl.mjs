...
import { $ as Route$4, e as collectionSearchToFilters, f as filterAndSortBonsais, B as Button, c as styleLabel, E as etapeLabel, m as ageActuel, x as saveBonsai, a0 as deleteBonsai, d as cn, _ as getBonsai, D as getPoterie, C as listPhotos, v as getPhotoBlob, b as soinLabel, l as listBonsais } from "./router-t0ineTAC.mjs";
import { l as listJournal } from "./journal-Vg7D2S9t.mjs";
import { l as listRappels } from "./rappel-CwFhbXlh.mjs";
import { A as AppShell } from "./app-shell-C-GdKYd6.mjs";
import { B as BonsaiForm } from "./bonsai-form-D4D-JRD8.mjs";
...
const UnifiedTimeline = reactExports.lazy(() => import("./unified-timeline-C8cWlP0l.mjs"));
const RappelsTab = reactExports.lazy(() => import("./rappels-tab-Hvf7juoT.mjs"));
...
function BonsaiDetail() {
  ...
  const remove = async () => {
    ...
    try {
      ...
      toast.error("Échec de la suppression : " + (e instanceof Error ? e.message : "erreur inconnue"));
      return;
    }
  ...
  const toggleFavori = async () => {
    try {
      ...
      toast.error("Échec de la mise à jour : " + (e instanceof Error ? e.message : "erreur inconnue"));
      return;
    }
    qc.invalidateQueries({
      queryKey: ["bonsai", id]
  ...
  const setMainPhoto = async (pid) => {
    ...
    try {
      ...
      toast.error("Échec de la mise à jour de la photo principale : " + (e instanceof Error ? e.message : "erreur inconnue"));
      return;
    }
    qc.invalidateQueries({
      queryKey: ["bonsai", id]
