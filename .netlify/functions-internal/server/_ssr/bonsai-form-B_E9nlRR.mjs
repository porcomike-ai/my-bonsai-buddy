...
import { f as useAuth, u as uid, h as saveBonsai, i as savePhoto, L as Label, I as Input, T as Textarea, B as Button, A as AddPhotoDialog, q as cn, a as listPoteries } from "./router-CdX15gXw.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "grid gap-8 lg:grid-cols-[280px_1fr]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Âge estimé (années)", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", min: 0, ...form.register("ageEstime"), placeholder: "35" }) }),
