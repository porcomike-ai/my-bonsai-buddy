...
import { a9 as useFileInput, B as Button, X as AddPhotoDialog, I as Input, T as Textarea, ab as updatePhotoDate, ac as updatePhotoLegende, ad as deletePhoto, A as savePoterieGalleryPhoto, u as uid, Y as useBlobUrl } from "./router-t0ineTAC.mjs";
...
import { d as Camera, Q as FolderOpen, e as Calendar, R as MessageSquarePlus, X } from "../_libs/lucide-react.mjs";
...
function usePhotoUrl(photo) {
  ...
  reactExports.useEffect(() => {
    ...
    getCachedPhotoBlob({ storagePath, poterieId }).then((b) => {
