...
import { p as useAuth, a4 as getAllEspeces, u as uid, a5 as addCustomEspece, z as saveBonsai, C as savePhoto, L as Label, I as Input, S as STYLES, a0 as ETAPES, T as Textarea, B as Button, _ as AddPhotoDialog, d as cn, a as listPoteries, l as listBonsais } from "./router-BaPlfOky.mjs";
...
function BonsaiForm({
  ...
  const normalizeNom = (s) => s.trim().toLocaleLowerCase("fr").normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/\s+/g, " ");
  const findDuplicateName = (nom) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "grid gap-8 lg:grid-cols-[280px_1fr]", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Nom", error: form.formState.errors.nom?.message, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            ...form.register("nom", {
              onChange: (e) => {
              ...
              onBlur: (e) => {
                if (form.formState.errors.nom) return;
