...
import { P as PhotoLightbox } from "./photo-lightbox-BlFnrxbc.mjs";
import { B as Button, a9 as useFileInput, X as AddPhotoDialog, ab as updatePhotoDate, ac as updatePhotoLegende, ad as deletePhoto, F as Dialog, H as DialogContent, J as DialogHeader, K as DialogTitle, L as Label, aa as SOINS_SELECTABLE, I as Input, T as Textarea, P as DialogFooter, z as savePhoto, u as uid, s as soinEmoji, b as soinLabel, Y as useBlobUrl } from "./router-t0ineTAC.mjs";
import { u as useConfirm } from "./confirm-dialog-QzBIRisU.mjs";
import { invalidateCachedPhoto, getCachedPhotoBlob } from "./photo-cache-LDr-U0DB.mjs";
import { d as deleteJournal, s as saveJournal } from "./journal-Vg7D2S9t.mjs";
...
function JournalEntryDialog({
  ...
  const [journalType, setJournalType] = reactExports.useState("rempotage");
  ...
  const saveJournalEntry = async () => {
    ...
    try {
      ...
      toast.error(
        "Échec de l'enregistrement de l'entrée : " + (e instanceof Error ? e.message : "erreur inconnue")
      );
      return;
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              ...
              children: SOINS_SELECTABLE.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: s.value, children: [
                s.emoji,
                " ",
                s.label
              ] }, s.value))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
              ...
              rows: 3,
              placeholder: journalType === "autre" ? "Décrivez cet événement…" : "Observations, détails…"
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogFooter, { className: "flex-col gap-2 sm:flex-row sm:justify-between", children: entry ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "destructive",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => onOpenChange(false), children: "Annuler" }),
...
function usePhotoUrl(photo) {
  ...
  reactExports.useEffect(() => {
    ...
    getCachedPhotoBlob({ storagePath, poterieId: photo.poterieId }).then((b) => {
...
function UnifiedTimeline({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5 grid grid-cols-2 gap-3 sm:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(PhotoUploadButtons, { bonsaiId }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
