...
import { B as Button, L as Label, a6 as SOINS_SELECTABLE, I as Input, s as soinEmoji, b as soinLabel, u as uid } from "./router-Dgs5QC_7.mjs";
import { s as saveJournal, d as deleteJournal } from "./journal-BAlYNI2g.mjs";
import { s as saveRappel, d as deleteRappel } from "./rappel-DXFdD1h8.mjs";
import "../_libs/lovable.dev__mcp-js.mjs";
import "../_libs/modelcontextprotocol__sdk.mjs";
import "../_libs/zod-to-json-schema.mjs";
import "../_libs/ajv-formats.mjs";
import { P as Plus, e as Calendar, b as Check, X } from "../_libs/lucide-react.mjs";
import { f as format, a as fr, p as parseISO, b as addDays } from "../_libs/date-fns.mjs";
...
function RappelsTab({
  ...
  const [type, setType] = reactExports.useState("rempotage");
  ...
  const markDone = async (r) => {
    ...
    try {
      ...
      toast.error(
        "Échec de l'enregistrement du soin : " + (e instanceof Error ? e.message : "erreur inconnue")
      );
      return;
    }
    try {
      ...
      try {
        ...
        toast.error(
          "Échec de la mise à jour du rappel, le soin n'a pas été enregistré : " + (e instanceof Error ? e.message : "erreur inconnue")
        );
      } catch {
