...
export function BonsaiForm({ initial, onSaved }: { initial?: Bonsai; onSaved?: (b: Bonsai) => void }) {
  ...
  const form = useForm<FormValues>({
    ...
    defaultValues: {
      ...
      ageEstime: initial?.ageEstime ?? "",
      hauteurCm: initial?.hauteurCm ?? "",
  ...
  const submit = form.handleSubmit(async (values) => {
    ...
    const b: Bonsai = {
      ...
      ageEstime: values.ageEstime === "" ? undefined : Number(values.ageEstime),
      hauteurCm: values.hauteurCm === "" ? undefined : Number(values.hauteurCm),
