...
export function PoterieGalerieTab({
  poterieId,
  photos,
}: {
  poterieId: string;
    ...
    <div>
      ...
      {sorted.length === 0 ? (
        <p className="text-sm text-muted-foreground">
          Aucune photo pour l'instant. Ajoutez des vues de cette poterie sous différents angles ou avec différents arbres.
        </p>
      ) : (
        <>
...
export default PoterieGalerieTab;
